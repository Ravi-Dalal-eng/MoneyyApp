...
import com.messaging.movieapp.databinding.FragmentWatchlistBinding
...
class WatchlistFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.watchListMoviesList.layoutManager= LinearLayoutManager(requireContext())
        binding.watchListMoviesList.adapter= SelectedMovieAdapter(requireContext(),movies,
        ...
        database.reference.child(auth.currentUser!!.uid).child("watchlist")
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    binding.watchListMoviesList.adapter!!.notifyDataSetChanged()
                }
